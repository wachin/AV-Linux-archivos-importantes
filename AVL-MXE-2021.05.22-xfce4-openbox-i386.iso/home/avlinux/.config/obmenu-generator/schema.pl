...
our $SCHEMA = [
    ...
    #          COMMAND                 LABEL              ICON
    {item => ['minstall-pkexec', 'Install AVL-MXE to HDD',  'minstall']},
    {item => ['mx-manual', 'Read the MX User Manual',  'help']},
    {item => ['evince /usr/share/doc/avl-mxe-user-manual/AVL-MXE-User-Manual.pdf', 'Read the AVL-MXE User Manual',  'help']},
    {item => ['firefox', 'Web Browser',  'firefox']},
    {item => ['xdg-open .',       'File Manager', 'system-file-manager']},
    {item => ['xfce4-terminal',   'Terminal',     'utilities-terminal']},
    {item => ['gksu synaptic',   'Package Manager',     'synaptic']},
    {item => ['avlassistant',   'AVL-MXE Assistant',    'avl-mxe-assistant']},
    {item => ['mx-tools',   'MX-Tools',    'mx-tools']},
    {item => ['qjackctl',   'Start JACK',    'qjackctl']},
    ...
    # X{exit => ['Exit', 'application-exit']},

    ## This uses the 'oblogout' menu
    # {item => ['oblogout', 'Exit', 'application-exit']},

   ## Custom Logout Script
      {item => ['logout.sh', 'Log Out', 'logout']},
